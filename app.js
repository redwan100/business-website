...
window.addEventListener("scroll", () => {
  ...
  if (scrollTop + window.innerHeight > shape4.offsetTop) {
    shape4.style.transform = `translateY(${scrollTop * 0.8}px) `;
    rightImg.style.transform = `translateY(${scrollTop * 0.6}px)`;
    aboutLeft.style.transform = `translateY(${scrollTop * -0.8}px) `;
...
gsap.timeline()
    .from('.about__section-description', {
        duration: 2,
        y: 500,
        opacity: 0,
        delay:0.7
